...
function Register() {
  ...
  async function register(ev) {
    ...
    const response = await fetch('http://localhost:4000/register', {
      method: 'POST',
      body: JSON.stringify({ firstName, lastName, password, course, employmentStatus, country, email, phoneNumber }),
  ...
  return (
    <>
      ...
      <div class="min-w-screen min-h-screen bg-neutral-300 flex items-center justify-center px-5 py-5">
        <div class=" max-w-screen-xl bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" >
          <div class="md:flex w-full">
            <div class="hidden md:block w-1/2 bg-blue-950 py-10 px-10">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
              <div class="text-center mb-10">
                ...
                <p class="text-black">Enter your information to register, so we can communicate with you of future events</p>
              </div>
                ...
                <div class="flex -mx-3">
                  <div class="w-1/2 px-3 mb-5">
                    ...
                    <div class="flex">
                      ...
                      <input type="text" onChange={ev => setFirstName(ev.target.value)} value={firstName} class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 bg-neutral-100 focus:bg-neutral-200" placeholder="John"/>
                    </div>
                  </div>
                  <div class="w-1/2 px-3 mb-5">
                    ...
                    <div class="flex">
                      <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                      <input type="text" onChange={ev => setLastName(ev.target.value)} value={lastName} class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 bg-neutral-100 focus:bg-neutral-200" placeholder="Smith"/>
                    </div>
                  </div>
                </div>
                <div class="flex -mx-3">
                  <div class="w-1/2 px-3 mb-5">
                    <label for="" class="text-xs font-semibold px-1">Course taken</label>
                    <div class="flex">
                      <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                      <input type="text" onChange={ev => setCourse(ev.target.value)} value={course} class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 bg-neutral-100 focus:bg-neutral-200" placeholder="Education, Marketing e.t.c" />
                    </div>
                  </div>
                  <div class="w-1/2 px-3 mb-5">
                    <label for="" class="text-xs font-semibold px-1">Employment Status</label>
                    <div class="flex">
                      <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                      <input type="text" onChange={ev => setEmploymentStatus(ev.target.value)} value={employmentStatus} class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 bg-neutral-100 focus:bg-neutral-200" placeholder="Employed, Self-employed e.t.c" />
                    </div>
                  </div>
                </div>
                <div class="flex -mx-3">
                  <div class="w-1/2 px-3 mb-5">
                    ...
                    <div class="flex">
                      <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                      <input type="text" onChange={ev => setCountry(ev.target.value)} value={country} class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 bg-neutral-100 focus:bg-neutral-200" placeholder="Kenya, Rwanda, Ethiopia e.t.c" />
                    </div>
                  </div>
                  <div class="w-1/2 px-3 mb-5">
                    ...
                    <div class="flex">
                      <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                      <input type="text" onChange={ev => setPhoneNumber(ev.target.value)} value={phoneNumber} class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 bg-neutral-100 focus:bg-neutral-200" placeholder="+254 712 345 678" />
                    </div>
                  </div>
                </div>
                <div class="flex -mx-3">
                  <div class="w-full px-3 mb-5">
                    ...
                    <div class="flex">
                      ...
                      <input type="email" onChange={ev => setEmail(ev.target.value)} value={email} class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 bg-neutral-100 focus:bg-neutral-200" placeholder="johnsmith@example.com" required/>
                    </div>
                  </div>
                </div>
                <div class="flex -mx-3">
                  <div class="w-full px-3 mb-12">
                    ...
                    <div class="flex">
                      ...
                      <input type="password" onChange={ev => setPassword(ev.target.value)} value={password} class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 bg-neutral-100 focus:bg-neutral-200" placeholder="************" required/>
                    </div>
                  </div>
                </div>
                <div class="flex -mx-3">
                  <div class="w-full px-3 mb-5">
                    <div className="flex justify-center">
                      <button type="submit" className="w-2/5 text-white bg-blue-950 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
                    </div>
